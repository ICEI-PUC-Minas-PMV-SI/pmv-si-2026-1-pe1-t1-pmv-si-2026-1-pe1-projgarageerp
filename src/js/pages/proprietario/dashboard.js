...
function AtualizarStatus(id, numeroOS, status){
    ...
    const estados = {
        concluido: { img: "../../assets/icons/icon-green-check-circle.svg", texto: "Concluído" },
        andamento: { img: "../../assets/icons/icon-orange-clock.svg", texto: "Em andamento" },
        atrasado: { img: "../../assets/icons/icon-red-warning-circle.svg", texto: "Atrasado" },
        pendente : {img: "../../assets/icons/icon-blue-file.svg", texto: "Pendente"}
    };
